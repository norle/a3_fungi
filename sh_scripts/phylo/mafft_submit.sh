...
mkdir -p out_mafft
mkdir -p /work3/s233201/output_phyl/supermatrix/alignments
...
for seq_file in /work3/s233201/output_phyl/supermatrix/sequences/*.faa; do
    ...
    bsub -J "mafft_${filename}" \
         ...
         "source ~/miniconda3/etc/profile.d/conda.sh && \
          ...
          mafft --auto --thread 8 ${seq_file} > /work3/s233201/output_phyl/supermatrix/alignments/${filename}.aln"
done
